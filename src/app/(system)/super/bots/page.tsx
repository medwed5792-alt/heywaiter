...
/**
 * Супер-админ: настройки ботов (все 8 каналов, включая Line).
 * Раньше: /admin/settings/bots.
 */
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-gray-600">
        Токены задаются через переменные окружения (TELEGRAM_CLIENT_TOKEN, VK_CLIENT_TOKEN, LINE_CLIENT_TOKEN и т.д.). Кнопка «Тест связи» проверяет работу вебхука (getMe для Telegram).
      </p>
